...
abstract class AblogHelper
{
	...
	public static function addSubmenu($vName)
	{
		JSubMenuHelper::addEntry(
			JText::_('CPanel'),
			'index.php?option=com_ablog&view=cpanel',
			$vName == 'cpanel'
		);
		JSubMenuHelper::addEntry(
			JText::_('Blog_Kategories'),
			'index.php?option=com_ablog&amp;act=blog_categories',
			$vName == 'blog_categories');
		JSubMenuHelper::addEntry(
			JText::_('Posts'),
			'index.php?option=com_ablog&amp;act=posts',
			$vName == 'posts'
		);
		JSubMenuHelper::addEntry(
			JText::_('Comments'),
			'index.php?option=com_ablog&amp;act=comments',
			$vName == 'comments'
		);
		JSubMenuHelper::addEntry(
			JText::_('Comment_Answers'),
			'index.php?option=com_ablog&amp;act=comment_answers',
			$vName == 'comment_answers'
		);
	}
	 ...
	 */
	 public static function getActions($messageId = 0) {
             ...
             $result = new JObject;
             if (empty($messageId)) {$assetName = 'com_ablog';} else {
